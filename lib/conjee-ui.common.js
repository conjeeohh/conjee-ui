...
__webpack_require__.d(__webpack_exports__, "CoButton", function() { return /* reexport */ co_botton; });
__webpack_require__.d(__webpack_exports__, "CoIcon", function() { return /* reexport */ co_icon; });
__webpack_require__.d(__webpack_exports__, "CoInput", function() { return /* reexport */ co_input; });
__webpack_require__.d(__webpack_exports__, "CoInputpro", function() { return /* reexport */ co_inputpro; });
__webpack_require__.d(__webpack_exports__, "CoSelect", function() { return /* reexport */ co_select; });
__webpack_require__.d(__webpack_exports__, "CoOption", function() { return /* reexport */ co_option; });
__webpack_require__.d(__webpack_exports__, "BlockCode", function() { return /* reexport */ block_code; });
__webpack_require__.d(__webpack_exports__, "BlockTable", function() { return /* reexport */ block_table; });
__webpack_require__.d(__webpack_exports__, "CoTable", function() { return /* reexport */ co_table; });
__webpack_require__.d(__webpack_exports__, "CoTableColumn", function() { return /* reexport */ packages_co_table_column; });
__webpack_require__.d(__webpack_exports__, "CoCheckbox", function() { return /* reexport */ co_checkbox; });
__webpack_require__.d(__webpack_exports__, "CoCheckboxGroup", function() { return /* reexport */ co_checkbox_group; });
__webpack_require__.d(__webpack_exports__, "CoRadio", function() { return /* reexport */ co_radio; });
__webpack_require__.d(__webpack_exports__, "CoRadioGroup", function() { return /* reexport */ co_radio_group; });
__webpack_require__.d(__webpack_exports__, "CoSwitch", function() { return /* reexport */ co_switch; });
__webpack_require__.d(__webpack_exports__, "CoCard", function() { return /* reexport */ co_card; });
__webpack_require__.d(__webpack_exports__, "CoProgress", function() { return /* reexport */ co_progress; });
__webpack_require__.d(__webpack_exports__, "CoRow", function() { return /* reexport */ co_row; });
__webpack_require__.d(__webpack_exports__, "CoCol", function() { return /* reexport */ co_col; });
__webpack_require__.d(__webpack_exports__, "CoDivider", function() { return /* reexport */ co_divider; });
__webpack_require__.d(__webpack_exports__, "CoDialog", function() { return /* reexport */ co_dialog; });
__webpack_require__.d(__webpack_exports__, "CoForm", function() { return /* reexport */ co_form; });
__webpack_require__.d(__webpack_exports__, "CoFormItem", function() { return /* reexport */ co_form_item; });
__webpack_require__.d(__webpack_exports__, "CoRadioButton", function() { return /* reexport */ co_radio_button; });
__webpack_require__.d(__webpack_exports__, "CoTabs", function() { return /* reexport */ co_tabs; });
__webpack_require__.d(__webpack_exports__, "CoTabPane", function() { return /* reexport */ co_tab_pane; });
__webpack_require__.d(__webpack_exports__, "CoPagination", function() { return /* reexport */ co_pagination; });
...
var MessageBox = external_commonjs_vue_commonjs2_vue_root_Vue_default.a.extend(co_message_src); // 使用Vue.extend来创建一个构造器
...
var co_message_Message = function Message() {
  ...
  if (external_commonjs_vue_commonjs2_vue_root_Vue_default.a.prototype.$isServer) return; // 如果当前定时器已开启，说明页面上已经有一个message-box了，则不能再继续创建新的message-box
  // if (timer) return;
...
external_commonjs_vue_commonjs2_vue_root_Vue_default.a.use(co_message); // 所有组件列表
